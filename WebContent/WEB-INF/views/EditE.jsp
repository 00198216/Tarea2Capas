...
<div id="id01" class="modal">
  ...
  <form:form class="modal-content animate" action="${pageContext.request.contextPath}/EditEmpl" method="POST" modelAttribute="empleadoDTO">
		...
		<center>
		<input type="submit" class="button3 buttonAdd" value="Modificar Empleado">
              </div>
