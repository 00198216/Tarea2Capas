...
<div class="jumbotron jumbotron-fluid" style="background:#FAFAFA90">
  <div class="container">
    <h1 class="display-4">Agregar Sucursal</h1>
  </div>
</div>
<br>
</center>
...
<div id="id01" class="modal">
  ...
  <form:form class="modal-content animate" action="${pageContext.request.contextPath}/SaveA" method="POST" modelAttribute="sucursalDTO2">
		...
		<center>
		<input type="submit" class="button3 buttonAdd" value="Agregar Sucursal">
              </div>
